...
from convocc.src.utils.libvoxelize.voxelize import voxelize_mesh_
from convocc.src.utils.libmesh import check_mesh_contains
from convocc.src.common import make_3d_grid
...
class VoxelGrid:
    ...
    @classmethod
    def from_mesh(cls, mesh, resolution, loc=None, scale=None, method='fill'):
        bounds = mesh.bounds
