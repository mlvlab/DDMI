...
def main(args):
    ...
    train_queue, valid_queue, _ = get_loaders_eval(args.dataset, args.data,
                                                   args.batch_size, augment=False, drop_last_train=False,
                                                   shuffle_train=True, binarize_binary_datasets=False)
    print('len train queue', len(train_queue), 'len val queue', 'batch size', args.batch_size)
    ...
    file_path = os.path.join(args.fid_dir, 'afhqcat_256.npz')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='cifar10',
                        choices=['cifar10', 'ffhq_256', 'lsun_256', 'afhq_256'],
