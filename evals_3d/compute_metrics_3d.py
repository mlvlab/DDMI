...
all_pc_data = load_all_point_clouds_under_folder('/hub_data2/dogyun/nips_3d/sdf_stylegan_pc', n_threads=8, file_ending='.ply', verbose=True)
all_pc_data_ref = load_all_point_clouds_under_folder('/hub_data2/dogyun/nips_3d/gtchairpc', n_threads=8, file_ending='.ply', verbose=True)
